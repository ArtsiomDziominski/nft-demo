...
export const headerButtons: IButtons[] = [{name: 'Buy', to: '/buy'}, {name: 'Mint', to: '/mint', color: 'var(--main-green)'}, {name: 'employment', to: '/employment'}, {name: 'About', to: '/about'}]; //{name: 'Your collection', to: '/collection'},
