...
export const headerButtons: IButtons[] = [{name: 'Buy', to: '/buy'}, {name: 'Mint', to: '/mint', color: '#658d1b'}, {name: 'employment', to: '/employment'}, {name: 'Your collection', to: '/collection'}, {name: 'About', to: '/about'}]
